...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Bach\Downloads\KOP_Images\Actual needed\SteamFishHistoricMoment.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3738454866</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="SteamFishHistoricMoment.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="SteamFishHistoricMoment"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
